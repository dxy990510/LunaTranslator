                ...
                try: 
                    ...
                    if os.path.exists(game):
                        ...
                        if savehook_new_data[game]['leuse'] :
                                alwaysuselr=savehook_new_data[game]['alwaysuselr'] 
                                ...
                                if b==0 and alwaysuselr==False: 
                                        ...
                                        _cmd='LR'
                                win32utils.CreateProcess(None,f'"{le}" {_cmd} "{(game)}"', None,None,False,0,None, os.path.dirname(game), win32utils.STARTUPINFO()  ) 
                        else:
